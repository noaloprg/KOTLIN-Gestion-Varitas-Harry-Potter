package com.example.gestion_varitas_hp
...
class VaritasAdapter(context: Context, private val varitas: Array<InformacionVarita>) :
    ArrayAdapter<InformacionVarita>(context, R.layout.item_varita, varitas) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val vista = inflador.inflate(R.layout.item_varita, parent)
